    ...
    return (
        <div className="form-container">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <input type="text" name="bookType" value={formData.bookType} onChange={handleInputChange} required />
                <label>Book Title:</label>
                <input type="text" name="bookTitle" value={formData.bookTitle} onChange={handleInputChange} required />
